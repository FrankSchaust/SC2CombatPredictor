...
def main():
    ...
    for lr in learning_rates:
        for cfr in conv_to_fc_ratio:
            ...
            tensorboard_dir = os.path.join(REPO_DIR, 'tensorboard_logs', 'All_Convolutional_CNN', 'LearningRate_'+str(lr)+'_ConvToFcRatio_'+str(cfr)+'_SampleSize_'+str(capped_batch))
